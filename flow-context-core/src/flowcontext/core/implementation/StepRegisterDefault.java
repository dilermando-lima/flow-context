...
import flowcontext.core.base.FlowBase.StepRegisterBase;
...
public class StepRegisterDefault<I,O> implements StepRegisterBase<I,O> {
    ...
    public StepRegisterDefault<I, O> stepValidate(String name, PredictContext<I> predict) {
        stepQueue.add(
    ...
    public StepRegisterDefault<I, O> stepRetrive(String name, FunctionContext<Object, I> function) {
        stepQueue.add(
    ...
    public StepRegisterDefault<I, O> stepMap(String name, FunctionContext<Object, I> function) {
        stepQueue.add(
    ...
    public StepRegisterDefault<I, O> stepCheckSkipNext(String name, PredictContext<I> predict) {
        stepQueue.add(
    ...
    public StepRegisterDefault<I, O> stepExecute(String name, FunctionContext<Object, I> function) {
        stepQueue.add(
    ...
    public StepRegisterDefault<I, O> stepOnAbortFlow(String name, ConsumerContext<I> consumer) {
        stepQueue.add(
    ...
    public StepRegisterDefault<I, O> stepGost(String name, ConsumerContext<I> consumer) {
        stepQueue.add(
